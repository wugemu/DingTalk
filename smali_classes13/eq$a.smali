...
.method private setBackgroundColor(Landroid/widget/RemoteViews;)V
    ...
    .prologue
    .line 495
    iget-object v1, p0, Leq$a;->mBuilder:Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    .local v0, "color":I
    :goto_0
    sget v1, Lx$b;->status_bar_latest_event_content:I
    ...
    sget v2, Lx$a;->notification_material_background_media_default_color:I
...
.method public apply(Lcz;)V
    ...
    .line 389
    invoke-virtual {p0, v1}, Leq$a;->fillInMediaStyle(Landroid/app/Notification$MediaStyle;)Landroid/app/Notification$MediaStyle;
    ...
    .line 391
    :cond_0
    invoke-super {p0, p1}, Leq$b;->apply(Lcz;)V
...
.method getBigContentViewLayoutResource(I)I
    ...
    sget v0, Lx$d;->notification_template_big_media_narrow_custom:I

    :goto_0
    return v0

    :cond_0
    sget v0, Lx$d;->notification_template_big_media_custom:I
...
.method getContentViewLayoutResource()I
    ...
    .prologue
    .line 432
    iget-object v0, p0, Leq$a;->mBuilder:Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    sget v0, Lx$d;->notification_template_media_custom:I
    ...
    :cond_0
    invoke-super {p0}, Leq$b;->getContentViewLayoutResource()I
...
.method public makeBigContentView(Lcz;)Landroid/widget/RemoteViews;
    ...
    .line 447
    :cond_1
    iget-object v2, p0, Leq$a;->mBuilder:Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    .line 454
    invoke-virtual {p0}, Leq$a;->generateBigContentView()Landroid/widget/RemoteViews;

    move-result-object v0

    .line 455
    .local v0, "bigContentView":Landroid/widget/RemoteViews;
    invoke-virtual {p0, v0, v1}, Leq$a;->buildIntoRemoteViews(Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;)V
    ...
    .line 457
    invoke-direct {p0, v0}, Leq$a;->setBackgroundColor(Landroid/widget/RemoteViews;)V
...
.method public makeContentView(Lcz;)Landroid/widget/RemoteViews;
    ...
    .line 405
    :cond_0
    iget-object v6, p0, Leq$a;->mBuilder:Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    .line 413
    invoke-virtual {p0}, Leq$a;->generateContentView()Landroid/widget/RemoteViews;
    ...
    .line 415
    iget-object v3, p0, Leq$a;->mBuilder:Landroid/support/v4/app/NotificationCompat$Builder;

    invoke-virtual {v3}, Landroid/support/v4/app/NotificationCompat$Builder;->getContentView()Landroid/widget/RemoteViews;

    move-result-object v3

    invoke-virtual {p0, v0, v3}, Leq$a;->buildIntoRemoteViews(Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;)V
