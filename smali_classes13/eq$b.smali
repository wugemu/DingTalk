...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Leq$b;->mActionsToShowInCompact:[I
...
.method public constructor <init>(Landroid/support/v4/app/NotificationCompat$Builder;)V
    ...
    .line 138
    invoke-virtual {p0, p1}, Leq$b;->setBuilder(Landroid/support/v4/app/NotificationCompat$Builder;)V

    .line 139
    return-void
.end method

.method private generateMediaActionButton(Landroid/support/v4/app/NotificationCompat$a;)Landroid/widget/RemoteViews;
    .locals 4
    ...
    .line 279
    .line 4164
    iget-object v2, p1, Landroid/support/v4/app/NotificationCompat$a;->d:Landroid/app/PendingIntent;
    ...
    iget-object v2, p0, Leq$b;->mBuilder:Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    sget v3, Lx$d;->notification_media_action:I

    invoke-direct {v0, v2, v3}, Landroid/widget/RemoteViews;-><init>(Ljava/lang/String;I)V

    .line 282
    .local v0, "button":Landroid/widget/RemoteViews;
    sget v2, Lx$b;->action0:I

    .line 5154
    iget v3, p1, Landroid/support/v4/app/NotificationCompat$a;->b:I
...
.method public static getMediaSession(Landroid/app/Notification;)Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    invoke-static {v0, v4}, Lci;->a(Landroid/os/Bundle;Ljava/lang/String;)Landroid/os/IBinder;
...
.method public apply(Lcz;)V
    ...
    .line 210
    invoke-interface {p1}, Lcz;->a()Landroid/app/Notification$Builder;
    ...
    .line 211
    invoke-virtual {p0, v1}, Leq$b;->fillInMediaStyle(Landroid/app/Notification$MediaStyle;)Landroid/app/Notification$MediaStyle;
    ...
    .line 212
    :cond_1
    iget-boolean v0, p0, Leq$b;->mShowCancelButton:Z
...
.method fillInMediaStyle(Landroid/app/Notification$MediaStyle;)Landroid/app/Notification$MediaStyle;
    ...
    .prologue
    .line 219
    iget-object v0, p0, Leq$b;->mActionsToShowInCompact:[I
    ...
    .line 222
    :cond_0
    iget-object v0, p0, Leq$b;->mToken:Landroid/support/v4/media/session/MediaSessionCompat$Token;
...
.method generateBigContentView()Landroid/widget/RemoteViews;
    ...
    .line 310
    iget-object v4, p0, Leq$b;->mBuilder:Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    invoke-virtual {p0, v0}, Leq$b;->getBigContentViewLayoutResource(I)I

    move-result v4

    .line 311
    invoke-virtual {p0, v6, v4, v6}, Leq$b;->applyStandardTemplate(ZIZ)Landroid/widget/RemoteViews;

    move-result-object v1

    .line 314
    .local v1, "big":Landroid/widget/RemoteViews;
    sget v4, Lx$b;->media_actions:I
    ...
    invoke-direct {p0, v4}, Leq$b;->generateMediaActionButton(Landroid/support/v4/app/NotificationCompat$a;)Landroid/widget/RemoteViews;
    ...
    .end local v3    # "i":I
    :cond_0
    iget-boolean v4, p0, Leq$b;->mShowCancelButton:Z

    if-eqz v4, :cond_1

    .line 322
    sget v4, Lx$b;->cancel_action:I
    ...
    iget-object v6, p0, Leq$b;->mBuilder:Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    sget v7, Lx$c;->cancel_button_image_alpha:I
    ...
    iget-object v5, p0, Leq$b;->mCancelButtonIntent:Landroid/app/PendingIntent;
...
.method generateContentView()Landroid/widget/RemoteViews;
    ...
    .line 242
    .line 243
    invoke-virtual {p0}, Leq$b;->getContentViewLayoutResource()I

    move-result v7

    .line 242
    invoke-virtual {p0, v6, v7, v11}, Leq$b;->applyStandardTemplate(ZIZ)Landroid/widget/RemoteViews;

    move-result-object v5

    .line 245
    .local v5, "view":Landroid/widget/RemoteViews;
    iget-object v7, p0, Leq$b;->mBuilder:Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    iget-object v7, p0, Leq$b;->mActionsToShowInCompact:[I
    ...
    iget-object v8, p0, Leq$b;->mActionsToShowInCompact:[I
    ...
    .line 260
    .local v0, "action":Landroid/support/v4/app/NotificationCompat$a;
    invoke-direct {p0, v0}, Leq$b;->generateMediaActionButton(Landroid/support/v4/app/NotificationCompat$a;)Landroid/widget/RemoteViews;
    ...
    .line 264
    .end local v0    # "action":Landroid/support/v4/app/NotificationCompat$a;
    .end local v1    # "button":Landroid/widget/RemoteViews;
    .end local v2    # "i":I
    :cond_2
    iget-boolean v7, p0, Leq$b;->mShowCancelButton:Z

    if-eqz v7, :cond_3

    .line 265
    sget v7, Lx$b;->end_padder:I

    invoke-virtual {v5, v7, v9}, Landroid/widget/RemoteViews;->setViewVisibility(II)V

    .line 266
    sget v7, Lx$b;->cancel_action:I

    invoke-virtual {v5, v7, v6}, Landroid/widget/RemoteViews;->setViewVisibility(II)V

    .line 267
    sget v6, Lx$b;->cancel_action:I

    iget-object v7, p0, Leq$b;->mCancelButtonIntent:Landroid/app/PendingIntent;
    ...
    iget-object v8, p0, Leq$b;->mBuilder:Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    sget v9, Lx$c;->cancel_button_image_alpha:I
...
.method getBigContentViewLayoutResource(I)I
    ...
    sget v0, Lx$d;->notification_template_big_media_narrow:I

    :goto_0
    return v0

    :cond_0
    sget v0, Lx$d;->notification_template_big_media:I
...
.method getContentViewLayoutResource()I
    ...
    .prologue
    .line 293
    sget v0, Lx$d;->notification_template_media:I

    return v0
.end method

.method public makeBigContentView(Lcz;)Landroid/widget/RemoteViews;
    .locals 2
    .param p1, "builder"    # Lcz;
    .annotation build Landroid/support/annotation/RestrictTo;
        value = {
    ...
    :cond_0
    invoke-virtual {p0}, Leq$b;->generateBigContentView()Landroid/widget/RemoteViews;
...
.method public makeContentView(Lcz;)Landroid/widget/RemoteViews;
    .locals 2
    .param p1, "builder"    # Lcz;
    .annotation build Landroid/support/annotation/RestrictTo;
        value = {
    ...
    :cond_0
    invoke-virtual {p0}, Leq$b;->generateContentView()Landroid/widget/RemoteViews;
...
.method public setCancelButtonIntent(Landroid/app/PendingIntent;)Leq$b;
    .locals 0
    .param p1, "pendingIntent"    # Landroid/app/PendingIntent;

    .prologue
    .line 199
    iput-object p1, p0, Leq$b;->mCancelButtonIntent:Landroid/app/PendingIntent;

    .line 200
    return-object p0
.end method

.method public setMediaSession(Landroid/support/v4/media/session/MediaSessionCompat$Token;)Leq$b;
    .locals 0
    .param p1, "token"    # Landroid/support/v4/media/session/MediaSessionCompat$Token;

    .prologue
    .line 157
    iput-object p1, p0, Leq$b;->mToken:Landroid/support/v4/media/session/MediaSessionCompat$Token;

    .line 158
    return-object p0
.end method

.method public varargs setShowActionsInCompactView([I)Leq$b;
    .locals 0
    .param p1, "actions"    # [I

    .prologue
    .line 148
    iput-object p1, p0, Leq$b;->mActionsToShowInCompact:[I

    .line 149
    return-object p0
.end method

.method public setShowCancelButton(Z)Leq$b;
    .locals 2
    .param p1, "show"    # Z
    ...
    .line 187
    iput-boolean p1, p0, Leq$b;->mShowCancelButton:Z
