.class public Lcom/alibaba/android/dingtalkbase/uidic/cells/C1T2TextCell;
.super Lcom/alibaba/android/dingtalkbase/uidic/cells/BaseCell;
.source "C1T2TextCell.java"
...
.method public final a(II)V
    ...
    .prologue
    .line 161
    iget-object v0, p0, Lcom/alibaba/android/dingtalkbase/uidic/cells/C1T2TextCell;->a:Lcom/alibaba/android/dingtalkbase/uidic/cells/BaseCell$a;
...
.method protected final a(Landroid/content/res/TypedArray;)V
    ...
    iget-object v2, p0, Lcom/alibaba/android/dingtalkbase/uidic/cells/C1T2TextCell;->a:Lcom/alibaba/android/dingtalkbase/uidic/cells/BaseCell$a;
...
.method protected getLayout()I
    ...
    .prologue
    .line 49
    sget v0, Lcig$h;->layout_cell_c1t2:I
...
.method protected onLayout(ZIIII)V
    ...
    .line 112
    invoke-virtual {p0}, Lcom/alibaba/android/dingtalkbase/uidic/cells/C1T2TextCell;->getPaddingRight()I
    ...
    invoke-virtual {p0, v4}, Lcom/alibaba/android/dingtalkbase/uidic/cells/C1T2TextCell;->a(I)Landroid/view/View;
    ...
    .line 116
    invoke-static {v3}, Lcom/alibaba/android/dingtalkbase/uidic/cells/C1T2TextCell;->a(Landroid/view/View;)I
    ...
    invoke-virtual {p0, v4}, Lcom/alibaba/android/dingtalkbase/uidic/cells/C1T2TextCell;->b(I)I
    ...
    invoke-virtual {p0, v3, v4, v0}, Lcom/alibaba/android/dingtalkbase/uidic/cells/C1T2TextCell;->a(Landroid/view/View;II)V
    ...
    .line 138
    invoke-virtual {p0}, Lcom/alibaba/android/dingtalkbase/uidic/cells/C1T2TextCell;->getMeasuredHeight()I

    move-result v4

    invoke-static {v3}, Lcom/alibaba/android/dingtalkbase/uidic/cells/C1T2TextCell;->b(Landroid/view/View;)I
    ...
    .line 139
    invoke-static {v1}, Lcom/alibaba/android/dingtalkbase/uidic/cells/C1T2TextCell;->b(Landroid/view/View;)I
    ...
    .line 145
    invoke-virtual {p0}, Lcom/alibaba/android/dingtalkbase/uidic/cells/C1T2TextCell;->getPaddingLeft()I
    ...
    invoke-virtual {p0, v1, v4, v0}, Lcom/alibaba/android/dingtalkbase/uidic/cells/C1T2TextCell;->a(Landroid/view/View;II)V
    ...
    invoke-virtual {p0, v4}, Lcom/alibaba/android/dingtalkbase/uidic/cells/C1T2TextCell;->setContentCoordinate(I)V
...
.method protected onMeasure(II)V
    ...
    invoke-virtual {p0, v0}, Lcom/alibaba/android/dingtalkbase/uidic/cells/C1T2TextCell;->a(I)Landroid/view/View;
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/alibaba/android/dingtalkbase/uidic/cells/C1T2TextCell;->c(Landroid/view/View;IIII)Lcom/alibaba/android/dingtalkbase/uidic/cells/Cell$a;
    ...
    invoke-virtual/range {v4 .. v9}, Lcom/alibaba/android/dingtalkbase/uidic/cells/C1T2TextCell;->c(Landroid/view/View;IIII)Lcom/alibaba/android/dingtalkbase/uidic/cells/Cell$a;
    ...
    invoke-virtual/range {v4 .. v9}, Lcom/alibaba/android/dingtalkbase/uidic/cells/C1T2TextCell;->a(Landroid/view/View;IIII)I
    ...
    invoke-virtual/range {v4 .. v9}, Lcom/alibaba/android/dingtalkbase/uidic/cells/C1T2TextCell;->b(Landroid/view/View;IIII)I
    ...
    .line 105
    invoke-virtual {p0}, Lcom/alibaba/android/dingtalkbase/uidic/cells/C1T2TextCell;->getPaddingTop()I

    move-result v0

    add-int/2addr v0, v10

    invoke-virtual {p0}, Lcom/alibaba/android/dingtalkbase/uidic/cells/C1T2TextCell;->getPaddingBottom()I
    ...
    invoke-virtual {p0, v0, v10}, Lcom/alibaba/android/dingtalkbase/uidic/cells/C1T2TextCell;->setMeasuredDimension(II)V
