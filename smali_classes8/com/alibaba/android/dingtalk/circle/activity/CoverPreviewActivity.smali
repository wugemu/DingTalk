.class public Lcom/alibaba/android/dingtalk/circle/activity/CoverPreviewActivity;
...
.method private static a(Landroid/content/Intent;)Ljava/util/List;
    ...
    .line 71
    .local v8, "coverObjectList":Ljava/util/List;, "Ljava/util/List<Lcom/alibaba/android/dingtalk/circle/idl/objects/SNCoverObject;>;"
    :try_start_0
    ...
    check-cast v11, Lcom/alibaba/android/dingtalk/circle/idl/objects/SNCoverObject;

    .line 84
    .local v11, "obj":Lcom/alibaba/android/dingtalk/circle/idl/objects/SNCoverObject;
    new-instance v0, Lcom/alibaba/laiwang/photokit/picker/media/ImageItem;

    iget-object v2, v11, Lcom/alibaba/android/dingtalk/circle/idl/objects/SNCoverObject;->originUrl:Ljava/lang/String;

    iget-object v3, v11, Lcom/alibaba/android/dingtalk/circle/idl/objects/SNCoverObject;->mediaId:Ljava/lang/String;
...
.method static synthetic a(Lcom/alibaba/android/dingtalk/circle/activity/CoverPreviewActivity;Z)Z
    .locals 1
    .param p0, "x0"    # Lcom/alibaba/android/dingtalk/circle/activity/CoverPreviewActivity;
    .param p1, "x1"    # Z
    ...
    iput-boolean v0, p0, Lcom/alibaba/android/dingtalk/circle/activity/CoverPreviewActivity;->a:Z
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 50
    invoke-virtual {p0}, Lcom/alibaba/android/dingtalk/circle/activity/CoverPreviewActivity;->getIntent()Landroid/content/Intent;

    move-result-object v4

    invoke-static {v4}, Lcom/alibaba/android/dingtalk/circle/activity/CoverPreviewActivity;->a(Landroid/content/Intent;)Ljava/util/List;
    ...
    .line 53
    :cond_0
    invoke-virtual {p0}, Lcom/alibaba/android/dingtalk/circle/activity/CoverPreviewActivity;->finish()V
    ...
    :cond_1
    sget v4, Lbpu$e;->activity_cover_preview:I

    invoke-virtual {p0, v4}, Lcom/alibaba/android/dingtalk/circle/activity/CoverPreviewActivity;->setContentView(I)V
    ...
    invoke-virtual {p0}, Lcom/alibaba/android/dingtalk/circle/activity/CoverPreviewActivity;->getSupportFragmentManager()Lcn;
    ...
    sget v5, Lbpu$d;->fragment_container:I
...
.method public onCreateOptionsMenu(Landroid/view/Menu;)Z
    ...
    sget v2, Lbpu$f;->dt_circle_action_set_cover:I
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    .line 1108
    iget-boolean v0, p0, Lcom/alibaba/android/dingtalk/circle/activity/CoverPreviewActivity;->a:Z
    ...
    sget v2, Lbpu$d;->fragment_container:I
    ...
    .line 1120
    iput-boolean v1, p0, Lcom/alibaba/android/dingtalk/circle/activity/CoverPreviewActivity;->a:Z
    ...
    new-instance v4, Lcom/alibaba/android/dingtalk/circle/activity/CoverPreviewActivity$1;

    invoke-direct {v4, p0, v2}, Lcom/alibaba/android/dingtalk/circle/activity/CoverPreviewActivity$1;-><init>(Lcom/alibaba/android/dingtalk/circle/activity/CoverPreviewActivity;Ljava/lang/String;)V
    ...
    invoke-interface {v3, v2, v0}, Lbou;->a(Ljava/lang/String;Lcma;)V
