...
.method public a(Landroid/view/ViewParent;Landroid/view/View;)V
    ...
    invoke-interface {p1, p2}, Lgh;->onStopNestedScroll(Landroid/view/View;)V
...
.method public a(Landroid/view/ViewParent;Landroid/view/View;IIII)V
    ...
    invoke-interface/range {v0 .. v5}, Lgh;->onNestedScroll(Landroid/view/View;IIII)V
...
.method public a(Landroid/view/ViewParent;Landroid/view/View;II[I)V
    ...
    .end local p1    # "parent":Landroid/view/ViewParent;
    invoke-interface {p1, p2, p3, p4, p5}, Lgh;->onNestedPreScroll(Landroid/view/View;II[I)V
...
.method public a(Landroid/view/ViewParent;Landroid/view/View;FF)Z
    ...
    .end local p1    # "parent":Landroid/view/ViewParent;
    invoke-interface {p1, p2, p3, p4}, Lgh;->onNestedPreFling(Landroid/view/View;FF)Z
...
.method public a(Landroid/view/ViewParent;Landroid/view/View;FFZ)Z
    ...
    .end local p1    # "parent":Landroid/view/ViewParent;
    invoke-interface {p1, p2, p3, p4, p5}, Lgh;->onNestedFling(Landroid/view/View;FFZ)Z
...
.method public a(Landroid/view/ViewParent;Landroid/view/View;Landroid/view/View;I)Z
    ...
    .end local p1    # "parent":Landroid/view/ViewParent;
    invoke-interface {p1, p2, p3, p4}, Lgh;->onStartNestedScroll(Landroid/view/View;Landroid/view/View;I)Z
...
.method public b(Landroid/view/ViewParent;Landroid/view/View;Landroid/view/View;I)V
    ...
    .end local p1    # "parent":Landroid/view/ViewParent;
    invoke-interface {p1, p2, p3, p4}, Lgh;->onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
