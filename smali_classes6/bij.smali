...
.method public constructor <init>(Landroid/app/Activity;Laxs;)V
    ...
    .line 26
    iput-object p1, p0, Lbij;->g:Landroid/app/Activity;

    .line 27
    iput-object p2, p0, Lbij;->h:Laxs;
...
.method protected final a(Landroid/view/View;Landroid/widget/ListView;)V
    ...
    iput-object v0, p0, Lbij;->i:Landroid/widget/TextView;
...
.method protected final b(Lcom/alibaba/android/ding/base/objects/ObjectDing;IZ)V
    ...
    .line 57
    iget-object v0, p0, Lbij;->i:Landroid/widget/TextView;

    sget v1, Laxp$i;->ding_deadline_hide_done:I
    ...
    new-instance v1, Lbij$1;

    const/4 v2, 0x1

    invoke-direct {v1, p0, v2}, Lbij$1;-><init>(Lbij;Z)V
