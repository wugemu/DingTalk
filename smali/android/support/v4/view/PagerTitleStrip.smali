...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput v7, p0, Landroid/support/v4/view/PagerTitleStrip;->g:I
    ...
    iput-object v7, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Landroid/support/v4/view/PagerTitleStrip$a;
    ...
    .line 116
    sget-object v7, Landroid/support/v4/view/PagerTitleStrip;->n:[I
    ...
    invoke-static {v7, v4}, Landroid/support/v4/widget/TextViewCompat;->a(Landroid/widget/TextView;I)V
    ...
    .line 1220
    iget-object v8, p0, Landroid/support/v4/view/PagerTitleStrip;->d:Landroid/widget/TextView;
...
.method a(IFZ)V
    ...
    iget v0, v0, Landroid/support/v4/view/PagerTitleStrip;->g:I
    ...
    invoke-virtual/range {v42 .. v42}, Landroid/support/v4/view/ViewPager;->getAdapter()Lgl;
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v4/view/PagerTitleStrip;->a(ILgl;)V
    ...
    iput-boolean v0, v1, Landroid/support/v4/view/PagerTitleStrip;->k:Z
...
.method final a(ILgl;)V
    .locals 12
    .param p1, "currentItem"    # I
    .param p2, "adapter"    # Lgl;
    ...
    invoke-virtual {p2}, Lgl;->getCount()I
    ...
    iput-boolean v9, p0, Landroid/support/v4/view/PagerTitleStrip;->j:Z
    ...
    invoke-virtual {p2, v9}, Lgl;->getPageTitle(I)Ljava/lang/CharSequence;
    ...
    .line 275
    invoke-virtual {p2, p1}, Lgl;->getPageTitle(I)Ljava/lang/CharSequence;
    ...
    .line 296
    iget-boolean v9, p0, Landroid/support/v4/view/PagerTitleStrip;->k:Z
    ...
    .line 300
    :cond_2
    iput-boolean v8, p0, Landroid/support/v4/view/PagerTitleStrip;->j:Z
...
.method final a(Lgl;Lgl;)V
    .locals 1
    .param p1, "oldAdapter"    # Lgl;
    .param p2, "newAdapter"    # Lgl;
    ...
    invoke-virtual {p1, v0}, Lgl;->unregisterDataSetObserver(Landroid/database/DataSetObserver;)V
    ...
    invoke-virtual {p2, v0}, Lgl;->registerDataSetObserver(Landroid/database/DataSetObserver;)V
    ...
    invoke-virtual {p0, v0, p2}, Landroid/support/v4/view/PagerTitleStrip;->a(ILgl;)V
...
.method protected onAttachedToWindow()V
    ...
    invoke-virtual {v1}, Landroid/support/v4/view/ViewPager;->getAdapter()Lgl;

    move-result-object v0

    .line 247
    .local v0, "adapter":Lgl;
    iget-object v3, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Landroid/support/v4/view/PagerTitleStrip$a;

    invoke-virtual {v1, v3}, Landroid/support/v4/view/ViewPager;->setInternalPageChangeListener(Landroid/support/v4/view/ViewPager$d;)Landroid/support/v4/view/ViewPager$d;

    .line 248
    iget-object v3, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Landroid/support/v4/view/PagerTitleStrip$a;

    invoke-virtual {v1, v3}, Landroid/support/v4/view/ViewPager;->addOnAdapterChangeListener(Landroid/support/v4/view/ViewPager$c;)V

    .line 249
    iput-object v1, p0, Landroid/support/v4/view/PagerTitleStrip;->a:Landroid/support/v4/view/ViewPager;

    .line 250
    iget-object v3, p0, Landroid/support/v4/view/PagerTitleStrip;->m:Ljava/lang/ref/WeakReference;
    ...
    :goto_0
    invoke-virtual {p0, v3, v0}, Landroid/support/v4/view/PagerTitleStrip;->a(Lgl;Lgl;)V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-virtual {p0, v0, v2}, Landroid/support/v4/view/PagerTitleStrip;->a(Lgl;Lgl;)V

    .line 258
    iget-object v0, p0, Landroid/support/v4/view/PagerTitleStrip;->a:Landroid/support/v4/view/ViewPager;

    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->setInternalPageChangeListener(Landroid/support/v4/view/ViewPager$d;)Landroid/support/v4/view/ViewPager$d;
