.class public abstract Landroid/support/v4/app/NotificationCompat$n;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Landroid/support/v4/app/NotificationCompat$n;->mSummaryTextSet:Z
...
.method private calculateTopPadding()I
    ...
    .line 2228
    iget-object v5, p0, Landroid/support/v4/app/NotificationCompat$n;->mBuilder:Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    sget v5, Lg$b;->notification_top_pad:I
    ...
    .line 2230
    .local v3, "padding":I
    sget v5, Lg$b;->notification_top_pad_large_text:I
    ...
    invoke-static {v0, v7, v5}, Landroid/support/v4/app/NotificationCompat$n;->constrain(FFF)F
...
.method private createIconWithBackground(IIII)Landroid/graphics/Bitmap;
    ...
    .prologue
    .line 2190
    sget v4, Lg$c;->notification_icon_background:I
    ...
    :cond_0
    invoke-direct {p0, v4, p4, p2}, Landroid/support/v4/app/NotificationCompat$n;->createColoredBitmap(III)Landroid/graphics/Bitmap;
    ...
    .line 2193
    .local v0, "canvas":Landroid/graphics/Canvas;
    iget-object v4, p0, Landroid/support/v4/app/NotificationCompat$n;->mBuilder:Landroid/support/v4/app/NotificationCompat$Builder;
...
.method private hideNormalContent(Landroid/widget/RemoteViews;)V
    ...
    .line 2222
    sget v0, Lg$d;->title:I

    invoke-virtual {p1, v0, v1}, Landroid/widget/RemoteViews;->setViewVisibility(II)V

    .line 2223
    sget v0, Lg$d;->text2:I
...
.method public applyStandardTemplate(ZIZ)Landroid/widget/RemoteViews;
    ...
    iget-object v3, v0, Landroid/support/v4/app/NotificationCompat$n;->mBuilder:Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    .line 2032
    sget v3, Lg$d;->notification_background:I

    const-string/jumbo v4, "setBackgroundResource"

    sget v5, Lg$c;->notification_bg_low:I
    ...
    sget v5, Lg$c;->notification_template_icon_low_bg:I
    ...
    iget-object v4, v0, Landroid/support/v4/app/NotificationCompat$n;->mBuilder:Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    .line 2054
    sget v3, Lg$b;->notification_right_icon_size:I
    ...
    sget v3, Lg$b;->notification_small_icon_background_padding:I
    ...
    invoke-direct {v0, v3, v8, v11, v4}, Landroid/support/v4/app/NotificationCompat$n;->createIconWithBackground(IIII)Landroid/graphics/Bitmap;

    move-result-object v16

    .line 2064
    .local v16, "smallBit":Landroid/graphics/Bitmap;
    sget v3, Lg$d;->right_icon:I
    ...
    .line 2138
    sget v3, Lg$b;->notification_subtext_size:I
    ...
    iget-object v5, v0, Landroid/support/v4/app/NotificationCompat$n;->mBuilder:Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    sget v5, Lg$c;->notification_bg:I
    ...
    sget v5, Lg$c;->notification_template_icon_bg:I
    ...
    invoke-virtual {v0, v4, v5}, Landroid/support/v4/app/NotificationCompat$n;->createColoredBitmap(II)Landroid/graphics/Bitmap;
    ...
    .line 2074
    sget v3, Lg$b;->notification_large_icon_width:I

    invoke-virtual {v13, v3}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v3

    sget v4, Lg$b;->notification_big_circle_margin:I
    ...
    .line 2077
    .restart local v8    # "backgroundSize":I
    sget v3, Lg$b;->notification_small_icon_size_as_large:I
    ...
    .line 2105
    sget v3, Lg$e;->status_bar_notification_info_maxnum:I
    ...
    sget v4, Lg$g;->status_bar_notification_info_overflow:I
...
.method public build()Landroid/app/Notification;
    ...
    iget-object v1, p0, Landroid/support/v4/app/NotificationCompat$n;->mBuilder:Landroid/support/v4/app/NotificationCompat$Builder;
...
.method public buildIntoRemoteViews(Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;)V
    ...
    .line 2210
    invoke-direct {p0, p1}, Landroid/support/v4/app/NotificationCompat$n;->hideNormalContent(Landroid/widget/RemoteViews;)V

    .line 2211
    sget v0, Lg$d;->notification_main_column:I
    ...
    .line 2216
    sget v1, Lg$d;->notification_main_column_container:I

    .line 2217
    invoke-direct {p0}, Landroid/support/v4/app/NotificationCompat$n;->calculateTopPadding()I
...
.method public createColoredBitmap(II)Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, p1, p2, v0}, Landroid/support/v4/app/NotificationCompat$n;->createColoredBitmap(III)Landroid/graphics/Bitmap;
...
.method public makeHeadsUpContentView(Lcz;)Landroid/widget/RemoteViews;
    .locals 1
    .param p1, "builder"    # Lcz;
    .annotation build Landroid/support/annotation/RestrictTo;
        value = {
...
.method public setBuilder(Landroid/support/v4/app/NotificationCompat$Builder;)V
    ...
    .prologue
    .line 1953
    iget-object v0, p0, Landroid/support/v4/app/NotificationCompat$n;->mBuilder:Landroid/support/v4/app/NotificationCompat$Builder;

    if-eq v0, p1, :cond_0

    .line 1954
    iput-object p1, p0, Landroid/support/v4/app/NotificationCompat$n;->mBuilder:Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    invoke-virtual {v0, p0}, Landroid/support/v4/app/NotificationCompat$Builder;->setStyle(Landroid/support/v4/app/NotificationCompat$n;)Landroid/support/v4/app/NotificationCompat$Builder;
