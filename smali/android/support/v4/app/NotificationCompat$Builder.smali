...
.field public mStyle:Landroid/support/v4/app/NotificationCompat$n;
    .annotation build Landroid/support/annotation/RestrictTo;
        value = {
            .enum Landroid/support/annotation/RestrictTo$Scope;->LIBRARY_GROUP:Landroid/support/annotation/RestrictTo$Scope;
        }
...
.method public addAction(Landroid/support/v4/app/NotificationCompat$a;)Landroid/support/v4/app/NotificationCompat$Builder;
    .locals 1
...
.method public build()Landroid/app/Notification;
    ...
    .prologue
    .line 1861
    sget-object v0, Landroid/support/v4/app/NotificationCompat;->IMPL:Landroid/support/v4/app/NotificationCompat$m;

    invoke-virtual {p0}, Landroid/support/v4/app/NotificationCompat$Builder;->getExtender()Landroid/support/v4/app/NotificationCompat$c;

    move-result-object v1

    invoke-interface {v0, p0, v1}, Landroid/support/v4/app/NotificationCompat$m;->a(Landroid/support/v4/app/NotificationCompat$Builder;Landroid/support/v4/app/NotificationCompat$c;)Landroid/app/Notification;
...
.method public extend(Landroid/support/v4/app/NotificationCompat$e;)Landroid/support/v4/app/NotificationCompat$Builder;
    .locals 0
    .param p1, "extender"    # Landroid/support/v4/app/NotificationCompat$e;

    .prologue
    .line 1844
    invoke-interface {p1, p0}, Landroid/support/v4/app/NotificationCompat$e;->a(Landroid/support/v4/app/NotificationCompat$Builder;)Landroid/support/v4/app/NotificationCompat$Builder;
...
.method protected getExtender()Landroid/support/v4/app/NotificationCompat$c;
    .locals 1
    .annotation build Landroid/support/annotation/RestrictTo;
        value = {
            .enum Landroid/support/annotation/RestrictTo$Scope;->LIBRARY_GROUP:Landroid/support/annotation/RestrictTo$Scope;
...
.method public setStyle(Landroid/support/v4/app/NotificationCompat$n;)Landroid/support/v4/app/NotificationCompat$Builder;
    .locals 1
    .param p1, "style"    # Landroid/support/v4/app/NotificationCompat$n;

    .prologue
    .line 1694
    iget-object v0, p0, Landroid/support/v4/app/NotificationCompat$Builder;->mStyle:Landroid/support/v4/app/NotificationCompat$n;

    if-eq v0, p1, :cond_0

    .line 1695
    iput-object p1, p0, Landroid/support/v4/app/NotificationCompat$Builder;->mStyle:Landroid/support/v4/app/NotificationCompat$n;
    ...
    invoke-virtual {v0, p0}, Landroid/support/v4/app/NotificationCompat$n;->setBuilder(Landroid/support/v4/app/NotificationCompat$Builder;)V
