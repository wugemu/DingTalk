...
.field final mUpdateListener:Lgu;
...
.method public constructor <init>(Landroid/app/Activity;Z)V
    ...
    iput-object v2, p0, Landroid/support/v7/app/WindowDecorActionBar;->mHideListener:Lgs;
    ...
    iput-object v2, p0, Landroid/support/v7/app/WindowDecorActionBar;->mShowListener:Lgs;
    ...
    iput-object v2, p0, Landroid/support/v7/app/WindowDecorActionBar;->mUpdateListener:Lgu;
...
.method public constructor <init>(Landroid/app/Dialog;)V
    ...
    iput-object v0, p0, Landroid/support/v7/app/WindowDecorActionBar;->mHideListener:Lgs;
    ...
    iput-object v0, p0, Landroid/support/v7/app/WindowDecorActionBar;->mShowListener:Lgs;
    ...
    iput-object v0, p0, Landroid/support/v7/app/WindowDecorActionBar;->mUpdateListener:Lgu;
...
.method private init(Landroid/view/View;)V
    ...
    const-string/jumbo v7, " can only be used with a compatible window decor layout"
...
.method private setHasEmbeddedTabs(Z)V
    ...
    invoke-static {v3}, Landroid/support/v4/view/ViewCompat;->r(Landroid/view/View;)V
...
.method public animateToMode(Z)V
    ...
    invoke-interface {v3, v5, v8, v9}, Landroid/support/v7/widget/DecorToolbar;->setupAnimatorToVisibility(IJ)Lgr;

    move-result-object v1

    .line 889
    .local v1, "fadeOut":Lgr;
    ...
    invoke-virtual {v3, v4, v10, v11}, Landroid/support/v7/widget/ActionBarContextView;->setupAnimatorToVisibility(IJ)Lgr;
    ...
    invoke-virtual {v2, v1, v0}, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->playSequentially(Lgr;Lgr;)Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;

    .line 899
    invoke-virtual {v2}, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->start()V

    .line 910
    .end local v0    # "fadeIn":Lgr;
    .end local v1    # "fadeOut":Lgr;
    ...
    invoke-interface {v3, v4, v10, v11}, Landroid/support/v7/widget/DecorToolbar;->setupAnimatorToVisibility(IJ)Lgr;

    move-result-object v0

    .line 894
    .restart local v0    # "fadeIn":Lgr;
    iget-object v3, p0, Landroid/support/v7/app/WindowDecorActionBar;->mContextView:Landroid/support/v7/widget/ActionBarContextView;

    invoke-virtual {v3, v6, v8, v9}, Landroid/support/v7/widget/ActionBarContextView;->setupAnimatorToVisibility(IJ)Lgr;

    move-result-object v1

    .restart local v1    # "fadeOut":Lgr;
    goto :goto_1
...
.method public doHide(Z)V
    ...
    invoke-static {v4}, Landroid/support/v4/view/ViewCompat;->l(Landroid/view/View;)Lgr;

    move-result-object v4

    invoke-virtual {v4, v2}, Lgr;->b(F)Lgr;

    move-result-object v0

    .line 851
    .local v0, "a":Lgr;
    iget-object v4, p0, Landroid/support/v7/app/WindowDecorActionBar;->mUpdateListener:Lgu;

    invoke-virtual {v0, v4}, Lgr;->a(Lgu;)Lgr;

    .line 852
    invoke-virtual {v1, v0}, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->play(Lgr;)Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;
    ...
    invoke-virtual {v1, v4}, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->play(Lgr;)Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;
    ...
    .line 858
    iget-object v4, p0, Landroid/support/v7/app/WindowDecorActionBar;->mHideListener:Lgs;

    invoke-virtual {v1, v4}, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->setListener(Lgs;)Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;
    ...
    invoke-interface {v4, v5}, Lgs;->onAnimationEnd(Landroid/view/View;)V
...
.method public doShow(Z)V
    ...
    invoke-virtual {v4, v6}, Lgr;->b(F)Lgr;
    ...
    .line 819
    iget-object v4, p0, Landroid/support/v7/app/WindowDecorActionBar;->mShowListener:Lgs;
    ...
    invoke-static {v4}, Landroid/support/v4/view/ViewCompat;->r(Landroid/view/View;)V
...
.method public selectTab(Landroid/support/v7/app/ActionBar$Tab;)V
    ...
    invoke-virtual {v1}, Landroid/support/v4/app/FragmentActivity;->getSupportFragmentManager()Lcn;
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/FragmentTransaction;->f()Z
