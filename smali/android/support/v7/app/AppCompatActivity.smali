...
.method public onCreateSupportNavigateUpTaskStack(Ldn;)V
    .locals 2
    .param p1, "builder"    # Ldn;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    .end param
    ...
    invoke-interface {v0}, Ldn$a;->getSupportParentActivityIntent()Landroid/content/Intent;
    ...
    .line 1195
    iget-object v0, p1, Ldn;->b:Landroid/content/Context;
    ...
    .line 1197
    :cond_1
    invoke-virtual {p1, v0}, Ldn;->a(Landroid/content/ComponentName;)Ldn;

    .line 2146
    iget-object v0, p1, Ldn;->a:Ljava/util/ArrayList;
...
.method public onPrepareSupportNavigateUpTaskStack(Ldn;)V
    .locals 0
    .param p1, "builder"    # Ldn;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
...
.method public onSupportNavigateUp()Z
    ...
    .line 396
    invoke-static {p0}, Ldn;->a(Landroid/content/Context;)Ldn;

    move-result-object v0

    .line 397
    .local v0, "b":Ldn;
    invoke-virtual {p0, v0}, Landroid/support/v7/app/AppCompatActivity;->onCreateSupportNavigateUpTaskStack(Ldn;)V

    .line 398
    invoke-virtual {p0, v0}, Landroid/support/v7/app/AppCompatActivity;->onPrepareSupportNavigateUpTaskStack(Ldn;)V
    ...
    iget-object v4, v0, Ldn;->a:Ljava/util/ArrayList;
    ...
    .line 2312
    iget-object v3, v0, Ldn;->b:Landroid/content/Context;

    const/4 v4, 0x0

    invoke-static {v3, v2, v4}, Ldp;->a(Landroid/content/Context;[Landroid/content/Intent;Landroid/os/Bundle;)Z

    .line 402
    :try_start_0
    invoke-static {p0}, Lcd;->a(Landroid/app/Activity;)V
    :try_end_0
...
.method public supportNavigateUpTo(Landroid/content/Intent;)V
    ...
    .prologue
    .line 463
    invoke-static {p0, p1}, Lcx;->a(Landroid/app/Activity;Landroid/content/Intent;)V
