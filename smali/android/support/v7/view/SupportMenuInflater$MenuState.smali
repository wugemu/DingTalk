...
.method private setItem(Landroid/view/MenuItem;)V
    ...
    .line 463
    iget-boolean v2, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemChecked:Z

    invoke-interface {p1, v2}, Landroid/view/MenuItem;->setChecked(Z)Landroid/view/MenuItem;

    move-result-object v2

    iget-boolean v4, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemVisible:Z
    ...
    iget-boolean v4, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemEnabled:Z
    ...
    iget-object v2, v2, Landroid/support/v7/view/SupportMenuInflater;->mContext:Landroid/content/Context;
    ...
    .line 480
    invoke-virtual {v4}, Landroid/support/v7/view/SupportMenuInflater;->getRealOwner()Ljava/lang/Object;
    ...
    invoke-static {p1, v2}, Lgd;->a(Landroid/view/MenuItem;Landroid/support/v4/view/ActionProvider;)Landroid/view/MenuItem;

    .line 512
    :cond_7
    iget-object v2, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemContentDescription:Ljava/lang/CharSequence;

    invoke-static {p1, v2}, Lgd;->a(Landroid/view/MenuItem;Ljava/lang/CharSequence;)V

    .line 513
    iget-object v2, p0, Landroid/support/v7/view/SupportMenuInflater$MenuState;->itemTooltipText:Ljava/lang/CharSequence;

    invoke-static {p1, v2}, Lgd;->b(Landroid/view/MenuItem;Ljava/lang/CharSequence;)V
    ...
    invoke-static {p1, v2, v3}, Lgd;->b(Landroid/view/MenuItem;CI)V
    ...
    invoke-static {p1, v2, v3}, Lgd;->a(Landroid/view/MenuItem;CI)V
    ...
    invoke-static {p1, v2}, Lgd;->a(Landroid/view/MenuItem;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1, v2}, Lgd;->a(Landroid/view/MenuItem;Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v2, v3}, Landroid/support/v7/view/menu/MenuItemWrapperICS;->setExclusiveCheckable(Z)V
