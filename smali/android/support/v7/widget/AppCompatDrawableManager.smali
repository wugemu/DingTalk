...
.field private mKnownDrawableIdTags:Lfx;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lfx",
            "<",
...
.method private addDelegate(Ljava/lang/String;Landroid/support/v7/widget/AppCompatDrawableManager$InflateDelegate;)V
    ...
    .prologue
    .line 492
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatDrawableManager;->mDelegates:Lfk;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/AppCompatDrawableManager;->mDelegates:Lfk;
...
.method private addDrawableToCache(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    .line 420
    .local v0, "cache":Lfp;, "Lfp<Ljava/lang/ref/WeakReference<Landroid/graphics/drawable/Drawable$ConstantState;>;>;"
    if-nez v0, :cond_0

    .line 421
    new-instance v0, Lfp;

    .end local v0    # "cache":Lfp;, "Lfp<Ljava/lang/ref/WeakReference<Landroid/graphics/drawable/Drawable$ConstantState;>;>;"
    invoke-direct {v0}, Lfp;-><init>()V

    .line 422
    .restart local v0    # "cache":Lfp;, "Lfp<Ljava/lang/ref/WeakReference<Landroid/graphics/drawable/Drawable$ConstantState;>;>;"
    iget-object v2, p0, Landroid/support/v7/widget/AppCompatDrawableManager;->mDrawableCaches:Ljava/util/WeakHashMap;
    ...
    invoke-virtual {v0, p2, p3, v2}, Lfp;->b(JLjava/lang/Object;)V
...
.method private addTintListToCache(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    ...
    .line 575
    .local v0, "themeTints":Lfx;, "Lfx<Landroid/content/res/ColorStateList;>;"
    if-nez v0, :cond_1

    .line 576
    new-instance v0, Lfx;

    .end local v0    # "themeTints":Lfx;, "Lfx<Landroid/content/res/ColorStateList;>;"
    invoke-direct {v0}, Lfx;-><init>()V

    .line 577
    .restart local v0    # "themeTints":Lfx;, "Lfx<Landroid/content/res/ColorStateList;>;"
    iget-object v1, p0, Landroid/support/v7/widget/AppCompatDrawableManager;->mTintLists:Ljava/util/WeakHashMap;
    ...
    .line 579
    :cond_1
    invoke-virtual {v0, p2, p3}, Lfx;->b(ILjava/lang/Object;)V
...
.method private createButtonColorStateList(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 612
    invoke-static {v0, p2}, Ldt;->a(II)I
...
.method private createSwitchThumbColorStateList(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    .line 635
    .local v2, "thumbColor":Landroid/content/res/ColorStateList;
    if-eqz v2, :cond_0
...
.method private getCachedDrawable(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, p2, p3, v5}, Lfp;->a(JLjava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_1
    :try_start_1
    invoke-virtual {v0, p2, p3}, Lfp;->b(J)V
...
.method private getTintListFromCache(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 564
    .local v0, "tints":Lfx;, "Lfx<Landroid/content/res/ColorStateList;>;"
    if-eqz v0, :cond_0

    invoke-virtual {v0, p2}, Lfx;->a(I)Ljava/lang/Object;
    ...
    .line 566
    .end local v0    # "tints":Lfx;, "Lfx<Landroid/content/res/ColorStateList;>;"
    :cond_0
    return-object v1
.end method
...
.method private loadDrawableFromDelegates(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v14, v0, Landroid/support/v7/widget/AppCompatDrawableManager;->mDelegates:Lfk;
    ...
    invoke-virtual {v14}, Lfk;->isEmpty()Z
    ...
    iget-object v14, v0, Landroid/support/v7/widget/AppCompatDrawableManager;->mKnownDrawableIdTags:Lfx;
    ...
    invoke-virtual {v14, v0}, Lfx;->a(I)Ljava/lang/Object;
    ...
    .line 311
    invoke-virtual {v14, v3}, Lfk;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v14}, Lfx;-><init>()V

    move-object/from16 v0, p0

    iput-object v14, v0, Landroid/support/v7/widget/AppCompatDrawableManager;->mKnownDrawableIdTags:Lfx;
    ...
    invoke-virtual {v14, v0, v15}, Lfx;->b(ILjava/lang/Object;)V
    ...
    invoke-virtual {v14, v0, v11}, Lfx;->b(ILjava/lang/Object;)V
    ...
    invoke-virtual {v14, v11}, Lfk;->get(Ljava/lang/Object;)Ljava/lang/Object;
...
.method private tintDrawable(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    .line 268
    :cond_0
    invoke-static {p4}, Leb;->g(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;

    move-result-object p4

    .line 269
    invoke-static {p4, v1}, Leb;->a(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    .line 274
    invoke-static {p4, v2}, Leb;->a(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
...
.method final getDrawable(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    .line 200
    invoke-static {p1, p2}, Ldp;->a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
