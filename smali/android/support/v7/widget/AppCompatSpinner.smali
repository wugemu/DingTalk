...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    .local v8, "this":Landroid/support/v7/widget/AppCompatSpinner;
    :goto_0
    iput-object v9, v8, Landroid/support/v7/widget/AppCompatSpinner;->mPopupContext:Landroid/content/Context;
    ...
    .line 240
    new-instance v6, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;

    iget-object v9, p0, Landroid/support/v7/widget/AppCompatSpinner;->mPopupContext:Landroid/content/Context;

    invoke-direct {v6, p0, v9, p2, p3}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;-><init>(Landroid/support/v7/widget/AppCompatSpinner;Landroid/content/Context;Landroid/util/AttributeSet;I)V

    .line 241
    .local v6, "popup":Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;
    iget-object v9, p0, Landroid/support/v7/widget/AppCompatSpinner;->mPopupContext:Landroid/content/Context;
    ...
    .line 243
    .local v5, "pa":Landroid/support/v7/widget/TintTypedArray;
    sget v9, Landroid/support/v7/appcompat/R$styleable;->Spinner_android_dropDownWidth:I

    const/4 v10, -0x2

    invoke-virtual {v5, v9, v10}, Landroid/support/v7/widget/TintTypedArray;->getLayoutDimension(II)I
    ...
    .line 245
    invoke-virtual {v6, v9}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v6, v9}, Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;->setPromptText(Ljava/lang/CharSequence;)V

    .line 248
    invoke-virtual {v5}, Landroid/support/v7/widget/TintTypedArray;->recycle()V

    .line 250
    iput-object v6, p0, Landroid/support/v7/widget/AppCompatSpinner;->mPopup:Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;

    .line 251
    new-instance v9, Landroid/support/v7/widget/AppCompatSpinner$1;

    invoke-direct {v9, p0, p0, v6}, Landroid/support/v7/widget/AppCompatSpinner$1;-><init>(Landroid/support/v7/widget/AppCompatSpinner;Landroid/view/View;Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;)V
    ...
    .line 268
    .end local v5    # "pa":Landroid/support/v7/widget/TintTypedArray;
    .end local v6    # "popup":Landroid/support/v7/widget/AppCompatSpinner$DropdownPopup;
    :cond_2
    ...
    invoke-direct {v3, p1, v9, v4}, Landroid/widget/ArrayAdapter;-><init>(Landroid/content/Context;I[Ljava/lang/Object;)V
    ...
    .end local v8    # "this":Landroid/support/v7/widget/AppCompatSpinner;
    ...
    invoke-direct {v9, p1, v7}, Landroid/support/v7/view/ContextThemeWrapper;-><init>(Landroid/content/Context;I)V

    move-object v8, p0

    .end local p0    # "this":Landroid/support/v7/widget/AppCompatSpinner;
    .restart local v8    # "this":Landroid/support/v7/widget/AppCompatSpinner;
    goto/16 :goto_0
