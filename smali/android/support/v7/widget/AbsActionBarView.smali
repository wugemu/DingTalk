...
.field protected mVisibilityAnim:Lgr;
...
.method public animateToVisibility(I)V
    ...
    invoke-virtual {p0, p1, v2, v3}, Landroid/support/v7/widget/AbsActionBarView;->setupAnimatorToVisibility(IJ)Lgr;
...
.method public getAnimatedVisibility()I
    ...
    .prologue
    .line 150
    iget-object v0, p0, Landroid/support/v7/widget/AbsActionBarView;->mVisibilityAnim:Lgr;
...
.method public setupAnimatorToVisibility(IJ)Lgr;
    .locals 4
    .param p1, "visibility"    # I
    .param p2, "duration"    # J
    ...
    .line 157
    iget-object v2, p0, Landroid/support/v7/widget/AbsActionBarView;->mVisibilityAnim:Lgr;
    ...
    .line 165
    :cond_1
    invoke-static {p0}, Landroid/support/v4/view/ViewCompat;->l(Landroid/view/View;)Lgr;

    move-result-object v2

    const/high16 v3, 0x3f800000    # 1.0f

    invoke-virtual {v2, v3}, Lgr;->a(F)Lgr;

    move-result-object v0

    .line 166
    .local v0, "anim":Lgr;
    invoke-virtual {v0, p2, p3}, Lgr;->a(J)Lgr;
    ...
    invoke-virtual {v2, v0, p1}, Landroid/support/v7/widget/AbsActionBarView$VisibilityAnimListener;->withFinalVisibility(Lgr;I)Landroid/support/v7/widget/AbsActionBarView$VisibilityAnimListener;

    move-result-object v2

    invoke-virtual {v0, v2}, Lgr;->a(Lgs;)Lgr;

    move-object v1, v0

    .line 173
    .end local v0    # "anim":Lgr;
    .local v1, "anim":Lgr;
    :goto_0
    return-object v1

    .line 170
    .end local v1    # "anim":Lgr;
    :cond_2
    invoke-static {p0}, Landroid/support/v4/view/ViewCompat;->l(Landroid/view/View;)Lgr;
