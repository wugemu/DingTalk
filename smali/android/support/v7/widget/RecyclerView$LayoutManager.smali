...
.method public isViewPartiallyVisible(Landroid/view/View;ZZ)Z
    ...
    invoke-virtual {v3, p1, v4}, Landroid/support/v7/widget/ViewBoundsCheck;->isViewWithinBoundFlags(Landroid/view/View;I)Z
    ...
    .line 9332
    .local v0, "isViewFullyVisible":Z
    :goto_0
    if-eqz p2, :cond_1

    .line 9335
    .end local v0    # "isViewFullyVisible":Z
    :goto_1
    return v0
    ...
    .line 9335
    .restart local v0    # "isViewFullyVisible":Z
    :cond_1
    if-nez v0, :cond_2
...
.method public onInitializeAccessibilityNodeInfo(Landroid/support/v7/widget/RecyclerView$Recycler;Landroid/support/v7/widget/RecyclerView$State;Lgx;)V
    .locals 6
    .param p1, "recycler"    # Landroid/support/v7/widget/RecyclerView$Recycler;
    .param p2, "state"    # Landroid/support/v7/widget/RecyclerView$State;
    .param p3, "info"    # Lgx;
    ...
    invoke-virtual {p3, v1}, Lgx;->a(I)V

    .line 9742
    invoke-virtual {p3, v2}, Lgx;->j(Z)V
    ...
    invoke-virtual {v5, v1, v2, v3, v4}, Lgx$j;->a(IIZI)Ljava/lang/Object;

    move-result-object v1

    invoke-direct {v0, v1}, Lgx$k;-><init>(Ljava/lang/Object;)V

    .line 11093
    .local v0, "collectionInfo":Lgx$k;
    sget-object v1, Lgx;->a:Lgx$j;

    iget-object v2, p3, Lgx;->b:Landroid/view/accessibility/AccessibilityNodeInfo;

    check-cast v0, Lgx$k;

    .end local v0    # "collectionInfo":Lgx$k;
    iget-object v3, v0, Lgx$k;->a:Ljava/lang/Object;

    invoke-virtual {v1, v2, v3}, Lgx$j;->a(Landroid/view/accessibility/AccessibilityNodeInfo;Ljava/lang/Object;)V

    .line 9755
    return-void
.end method

.method onInitializeAccessibilityNodeInfo(Lgx;)V
    .locals 2
    .param p1, "info"    # Lgx;
    ...
    invoke-virtual {p0, v0, v1, p1}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->onInitializeAccessibilityNodeInfo(Landroid/support/v7/widget/RecyclerView$Recycler;Landroid/support/v7/widget/RecyclerView$State;Lgx;)V
...
.method public onInitializeAccessibilityNodeInfoForItem(Landroid/support/v7/widget/RecyclerView$Recycler;Landroid/support/v7/widget/RecyclerView$State;Landroid/view/View;Lgx;)V
    ...
    .line 9819
    .local v6, "itemInfo":Lgx$l;
    invoke-virtual {p4, v6}, Lgx;->a(Ljava/lang/Object;)V
...
.method onInitializeAccessibilityNodeInfoForItem(Landroid/view/View;Lgx;)V
    .locals 3
    ...
    invoke-virtual {p0, v1, v2, p1, p2}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->onInitializeAccessibilityNodeInfoForItem(Landroid/support/v7/widget/RecyclerView$Recycler;Landroid/support/v7/widget/RecyclerView$State;Landroid/view/View;Lgx;)V
