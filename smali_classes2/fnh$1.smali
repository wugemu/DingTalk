...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lfnh;->a(Ljava/util/List;)I
.end annotation
...
.field final synthetic c:Lfnh;


# direct methods
.method constructor <init>(Lfnh;Ljava/util/List;Ljava/util/concurrent/atomic/AtomicInteger;)V
    .locals 0
    .param p1, "this$0"    # Lfnh;

    .prologue
    .line 54
    iput-object p1, p0, Lfnh$1;->c:Lfnh;

    iput-object p2, p0, Lfnh$1;->a:Ljava/util/List;

    iput-object p3, p0, Lfnh$1;->b:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public final run()V
    ...
    :try_start_0
    iget-object v4, p0, Lfnh$1;->c:Lfnh;

    invoke-static {v4}, Lfnh;->b(Lfnh;)Lcom/alibaba/bee/DBManager;

    move-result-object v4

    iget-object v5, p0, Lfnh$1;->c:Lfnh;

    invoke-static {v5}, Lfnh;->a(Lfnh;)Ljava/lang/String;
    ...
    .line 60
    iget-object v4, p0, Lfnh$1;->a:Ljava/util/List;
    ...
    .line 66
    iget-object v5, p0, Lfnh$1;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    .line 72
    invoke-static {v3}, Lfnh;->a(Lcom/alibaba/bee/SQLiteStatement;)V
