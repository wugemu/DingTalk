...
.method static constructor <clinit>()V
    ...
    const-class v0, Lcom/ali/user/open/tbauth/ui/context/CallbackContext;

    invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lcom/ali/user/open/tbauth/ui/context/CallbackContext;->a:Ljava/lang/String;
...
.method public static onActivityResult(Landroid/app/Activity;IILandroid/content/Intent;)Z
    ...
    sget-object v3, Lcom/ali/user/open/tbauth/ui/context/CallbackContext;->a:Ljava/lang/String;
    ...
    const-class v0, Lcom/ali/user/open/tbauth/ui/support/ActivityResultHandler;

    invoke-static {v0}, Lcom/ali/user/open/core/context/KernelContext;->getService(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/ali/user/open/tbauth/ui/support/ActivityResultHandler;

    if-nez v0, :cond_1

    sget-object v0, Lcom/ali/user/open/tbauth/ui/context/CallbackContext;->a:Ljava/lang/String;

    new-instance v1, Ljava/lang/StringBuilder;

    const-string/jumbo v3, "No ActivityResultHandler handler to support the request code "
    ...
    invoke-static {v0, v1}, Lcom/ali/user/open/core/trace/SDKLogger;->i(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v1, Lcom/ali/user/open/tbauth/ui/context/CallbackContext;->a:Ljava/lang/String;

    new-instance v3, Ljava/lang/StringBuilder;

    const-string/jumbo v4, "No active activity is set, ignore post "
    ...
    invoke-interface/range {v0 .. v7}, Lcom/ali/user/open/tbauth/ui/support/ActivityResultHandler;->onActivityResult(IIILandroid/content/Intent;Landroid/app/Activity;Ljava/util/Map;Landroid/webkit/WebView;)V
