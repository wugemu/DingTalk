.class public Lcom/alibaba/android/user/connection/entry/upload/CircleUploadTaskEntry;
...
.annotation runtime Lcom/alibaba/bee/impl/table/DBTable;
    name = "tb_connection_upload_data"
.end annotation
...
.field public static final TABLE_NAME:Ljava/lang/String; = "tb_connection_upload_data"
...
.method public clear()V
    ...
    iput v0, p0, Lcom/alibaba/android/user/connection/entry/upload/CircleUploadTaskEntry;->type:I

    .line 58
    iput-object v1, p0, Lcom/alibaba/android/user/connection/entry/upload/CircleUploadTaskEntry;->url:Ljava/lang/String;

    .line 59
    iput-object v1, p0, Lcom/alibaba/android/user/connection/entry/upload/CircleUploadTaskEntry;->originUrl:Ljava/lang/String;

    .line 60
    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/alibaba/android/user/connection/entry/upload/CircleUploadTaskEntry;->isCompressed:Z
...
.method public fillContentValues(Landroid/content/ContentValues;)V
    ...
    iget v1, p0, Lcom/alibaba/android/user/connection/entry/upload/CircleUploadTaskEntry;->type:I
    ...
    iget-object v1, p0, Lcom/alibaba/android/user/connection/entry/upload/CircleUploadTaskEntry;->url:Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/alibaba/android/user/connection/entry/upload/CircleUploadTaskEntry;->originUrl:Ljava/lang/String;
    ...
    iget-boolean v1, p0, Lcom/alibaba/android/user/connection/entry/upload/CircleUploadTaskEntry;->isCompressed:Z
...
.method public fillWithObject(Lcom/alibaba/laiwang/photokit/picker/PhotoPickResult;)V
    ...
    iput-object v0, p0, Lcom/alibaba/android/user/connection/entry/upload/CircleUploadTaskEntry;->url:Ljava/lang/String;

    .line 77
    iget-object v0, p1, Lcom/alibaba/laiwang/photokit/picker/PhotoPickResult;->originUrl:Ljava/lang/String;

    iput-object v0, p0, Lcom/alibaba/android/user/connection/entry/upload/CircleUploadTaskEntry;->originUrl:Ljava/lang/String;
...
.method public bridge synthetic fillWithObject(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lcom/alibaba/android/user/connection/entry/upload/CircleUploadTaskEntry;->fillWithObject(Lcom/alibaba/laiwang/photokit/picker/PhotoPickResult;)V
...
.method public bridge synthetic toObject()Ljava/lang/Object;
    ...
    .prologue
    .line 14
    invoke-virtual {p0}, Lcom/alibaba/android/user/connection/entry/upload/CircleUploadTaskEntry;->toObject()Lcom/alibaba/laiwang/photokit/picker/PhotoPickResult;
