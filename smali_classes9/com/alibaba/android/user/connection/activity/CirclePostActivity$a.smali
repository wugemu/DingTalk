.class final Lcom/alibaba/android/user/connection/activity/CirclePostActivity$a;
...
# direct methods
.method private constructor <init>(Lcom/alibaba/android/user/connection/activity/CirclePostActivity;Lcom/alibaba/laiwang/photokit/picker/PhotoPickResult;)V
    .locals 0
    .param p2, "photo"    # Lcom/alibaba/laiwang/photokit/picker/PhotoPickResult;

    .prologue
    .line 824
    iput-object p1, p0, Lcom/alibaba/android/user/connection/activity/CirclePostActivity$a;->a:Lcom/alibaba/android/user/connection/activity/CirclePostActivity;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    .line 825
    iput-object p2, p0, Lcom/alibaba/android/user/connection/activity/CirclePostActivity$a;->b:Lcom/alibaba/laiwang/photokit/picker/PhotoPickResult;

    .line 826
    return-void
.end method

.method synthetic constructor <init>(Lcom/alibaba/android/user/connection/activity/CirclePostActivity;Lcom/alibaba/laiwang/photokit/picker/PhotoPickResult;B)V
    .locals 0
    .param p1, "x0"    # Lcom/alibaba/android/user/connection/activity/CirclePostActivity;
    .param p2, "x1"    # Lcom/alibaba/laiwang/photokit/picker/PhotoPickResult;

    .prologue
    .line 821
    invoke-direct {p0, p1, p2}, Lcom/alibaba/android/user/connection/activity/CirclePostActivity$a;-><init>(Lcom/alibaba/android/user/connection/activity/CirclePostActivity;Lcom/alibaba/laiwang/photokit/picker/PhotoPickResult;)V
...
.method public final onClick(Landroid/view/View;)V
    ...
    .line 830
    iget-object v1, p0, Lcom/alibaba/android/user/connection/activity/CirclePostActivity$a;->a:Lcom/alibaba/android/user/connection/activity/CirclePostActivity;

    invoke-static {v1}, Lcom/alibaba/android/user/connection/activity/CirclePostActivity;->e(Lcom/alibaba/android/user/connection/activity/CirclePostActivity;)Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Lcom/alibaba/android/user/connection/activity/CirclePostActivity$a;->a:Lcom/alibaba/android/user/connection/activity/CirclePostActivity;

    invoke-static {v2}, Lcom/alibaba/android/user/connection/activity/CirclePostActivity;->e(Lcom/alibaba/android/user/connection/activity/CirclePostActivity;)Ljava/util/ArrayList;

    move-result-object v2

    iget-object v3, p0, Lcom/alibaba/android/user/connection/activity/CirclePostActivity$a;->b:Lcom/alibaba/laiwang/photokit/picker/PhotoPickResult;
