...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    .line 16
    iput-object p1, p0, Lcom/amap/api/mapcore/util/gj;->b:Landroid/content/Context;

    .line 17
    iget-object v0, p0, Lcom/amap/api/mapcore/util/gj;->b:Landroid/content/Context;

    invoke-direct {p0, v0, p2}, Lcom/amap/api/mapcore/util/gj;->a(Landroid/content/Context;Z)Lcom/amap/api/mapcore/util/fz;

    move-result-object v0

    iput-object v0, p0, Lcom/amap/api/mapcore/util/gj;->a:Lcom/amap/api/mapcore/util/fz;

    .line 18
    return-void
.end method

.method private a(Landroid/content/Context;Z)Lcom/amap/api/mapcore/util/fz;
    .locals 4
...
.method public a()Ljava/util/List;
    ...
    .line 70
    :try_start_0
    invoke-static {}, Lcom/amap/api/mapcore/util/fm;->g()Ljava/lang/String;

    move-result-object v1

    .line 71
    iget-object v2, p0, Lcom/amap/api/mapcore/util/gj;->a:Lcom/amap/api/mapcore/util/fz;

    const-class v3, Lcom/amap/api/mapcore/util/fm;

    const/4 v4, 0x1

    invoke-virtual {v2, v1, v3, v4}, Lcom/amap/api/mapcore/util/fz;->a(Ljava/lang/String;Ljava/lang/Class;Z)Ljava/util/List;
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public a(Lcom/amap/api/mapcore/util/fm;)V
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lcom/amap/api/mapcore/util/gj;->a:Lcom/amap/api/mapcore/util/fz;
    ...
    invoke-direct {p0, v0, v1}, Lcom/amap/api/mapcore/util/gj;->a(Landroid/content/Context;Z)Lcom/amap/api/mapcore/util/fz;
    ...
    invoke-static {v0}, Lcom/amap/api/mapcore/util/fm;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    .line 50
    iget-object v1, p0, Lcom/amap/api/mapcore/util/gj;->a:Lcom/amap/api/mapcore/util/fz;
