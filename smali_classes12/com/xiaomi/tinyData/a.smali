...
.method public final a()V
    ...
    sget-object v5, Lcom/xiaomi/xmpush/thrift/g;->aj:Lcom/xiaomi/xmpush/thrift/g;

    invoke-virtual {v5}, Lcom/xiaomi/xmpush/thrift/g;->a()I

    move-result v5

    invoke-virtual {v4, v5, v3}, Lkaq;->a(IZ)Z

    move-result v4

    iput-boolean v4, p0, Lcom/xiaomi/tinyData/a;->c:Z

    invoke-static {v0}, Lkaq;->a(Landroid/content/Context;)Lkaq;

    move-result-object v0

    sget-object v4, Lcom/xiaomi/xmpush/thrift/g;->ak:Lcom/xiaomi/xmpush/thrift/g;
    ...
    invoke-virtual {v0, v4, v5}, Lkaq;->a(II)I
    ...
    iget v4, p0, Lcom/xiaomi/tinyData/a;->d:I
    ...
    iget v0, p0, Lcom/xiaomi/tinyData/a;->d:I
    ...
    invoke-static {v0}, Lket;->a(Landroid/content/Context;)Lket;

    move-result-object v4

    .line 3000
    iget-object v0, v4, Lket;->b:Ljava/util/Map;
    ...
    :cond_3
    :goto_2
    iget-object v4, p0, Lcom/xiaomi/tinyData/a;->b:Landroid/content/Context;

    invoke-static {v4}, Ljvn;->a(Landroid/content/Context;)Z
    ...
    sput-boolean v3, Lcom/xiaomi/tinyData/a;->a:Z

    iget-object v1, p0, Lcom/xiaomi/tinyData/a;->b:Landroid/content/Context;

    invoke-static {v1, v0}, Lker;->a(Landroid/content/Context;Lkeu;)V
    ...
    .line 5000
    :cond_7
    iget-object v5, p0, Lcom/xiaomi/tinyData/a;->b:Landroid/content/Context;
    ...
    const-string/jumbo v1, "TinyData(TinyDataCacheProcessor) no ready file to get data."
