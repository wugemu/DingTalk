...
.method public constructor <init>(Llgy;)V
    ...
    :goto_0
    invoke-direct {p0, p1, v0}, Lrx/internal/producers/QueuedValueProducer;-><init>(Llgy;Ljava/util/Queue;)V
...
.method public constructor <init>(Llgy;Ljava/util/Queue;)V
    ...
    .line 59
    iput-object p1, p0, Lrx/internal/producers/QueuedValueProducer;->child:Llgy;
...
.method private drain()V
    ...
    .line 97
    iget-object v0, p0, Lrx/internal/producers/QueuedValueProducer;->child:Llgy;
    ...
    :try_start_1
    invoke-virtual {v0, v5}, Llgy;->onNext(Ljava/lang/Object;)V
    :try_end_1
    ...
    :goto_3
    invoke-static {v1, v0, v8}, Llhe;->a(Ljava/lang/Throwable;Llgt;Ljava/lang/Object;)V
