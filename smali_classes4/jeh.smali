...
.method public static a(Landroid/content/Context;)Ljava/net/Proxy;
    ...
    invoke-static {p0, v1}, Ljeh;->a(Landroid/content/Context;Ljava/net/URI;)Ljava/net/Proxy;
    ...
    :cond_0
    invoke-static {p0}, Ljeh;->b(Landroid/content/Context;)Ljava/net/Proxy;
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method private static a(Landroid/content/Context;Ljava/net/URI;)Ljava/net/Proxy;
    ...
    invoke-static {p0}, Ljeh;->c(Landroid/content/Context;)Z
...
.method private static b(Landroid/content/Context;)Ljava/net/Proxy;
    ...
    invoke-static {}, Ljeh;->a()Ljava/lang/String;

    move-result-object v3

    invoke-static {}, Ljeh;->b()I
    :try_end_1
    ...
    invoke-static {p0}, Ljee;->r(Landroid/content/Context;)Ljava/lang/String;
