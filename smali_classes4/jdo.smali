...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ljdo;->b:Ljava/lang/String;
    ...
    sput-object v0, Ljdo;->o:[Ljava/lang/String;

    const-string/jumbo v0, "001;002;11B;11C;11F;11G;11H;11I;11K;121;122;135;13J;13S"

    sput-object v0, Ljdo;->c:Ljava/lang/String;
    ...
    sput-object v4, Ljdo;->g:Ljava/lang/String;

    sput-object v4, Ljdo;->h:Ljava/lang/String;

    sput-object v4, Ljdo;->p:Ljej;

    sput-boolean v3, Ljdo;->k:Z

    sput-boolean v3, Ljdo;->l:Z

    sput-boolean v3, Ljdo;->m:Z

    sput-boolean v3, Ljdo;->n:Z
...
.method public static a()Ljava/lang/String;
    ...
    sget-object v0, Ljdo;->a:Ljava/lang/String;

    return-object v0
.end method

.method public static a(Ljava/lang/String;Ljava/lang/String;)Ljej;
    .locals 4

    const/4 v0, 0x0

    :try_start_0
    new-instance v1, Ljej$a;

    const-string/jumbo v2, "AMAP_Location_SDK_Android 3.7.0"

    invoke-direct {v1, p0, p1, v2}, Ljej$a;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {}, Ljdo;->d()[Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1, v2}, Ljej$a;->a([Ljava/lang/String;)Ljej$a;

    move-result-object v1

    invoke-virtual {v1}, Ljej$a;->a()Ljej;
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static a(Landroid/content/Context;)V
    ...
    :try_start_0
    invoke-static {p0}, Ljdo;->e(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v0

    invoke-static {v0}, Ljdx;->a(Ljava/lang/String;)Z
    ...
    :cond_1
    :try_start_1
    sget-object v0, Ljdo;->j:Ljava/util/HashMap;
    ...
    sput-object v0, Ljdo;->j:Ljava/util/HashMap;
    ...
    sput-object v2, Ljdo;->i:Ljava/lang/String;
    :try_end_2
    ...
    invoke-static {v0}, Ljdo;->a(Ljava/lang/String;)[B

    move-result-object v1

    new-instance v0, Ljava/lang/String;

    invoke-static {v1, v2}, Ljdd;->d([BLjava/lang/String;)[B
...
.method public static a(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p0, p1, p2}, Ljeq;->b(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static b(Landroid/content/Context;)Ljava/lang/String;
    ...
    sget-object v0, Ljdo;->c:Ljava/lang/String;
    ...
    sget-object v1, Ljdo;->c:Ljava/lang/String;
...
.method public static b()Ljej;
    .locals 4

    .prologue
    .line 0
    :try_start_0
    sget-object v0, Ljdo;->p:Ljej;
    ...
    const-string/jumbo v1, "3.7.0"

    .line 1000
    iput-object v1, v0, Ljej$a;->b:Ljava/lang/String;
...
.method public static c()Z
    ...
    sget-boolean v0, Ljdo;->m:Z

    if-nez v0, :cond_0

    const/4 v0, 0x1

    sput-boolean v0, Ljdo;->m:Z

    sput-boolean v1, Ljdo;->n:Z
...
.method public static d(Landroid/content/Context;)V
    ...
    :cond_0
    sget-object v0, Ljdo;->b:Ljava/lang/String;
...
.method private static d()[Ljava/lang/String;
    ...
    sget-object v0, Ljdo;->o:[Ljava/lang/String;
