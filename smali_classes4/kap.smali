...
.method private static a(Ljava/lang/String;)Lkap$a;
    .locals 9
    ...
    new-instance v2, Lkap$a;

    const/4 v4, 0x0

    const v5, 0x19000

    invoke-direct {v2, v4, v5}, Lkap$a;-><init>([BI)V
    :try_end_6
...
.method public static a(Landroid/content/Context;Ljava/lang/String;)Lkap$b;
    .locals 6

    const/4 v3, 0x0

    new-instance v0, Lkap$b;

    const-wide/16 v4, 0x0

    invoke-direct {v0, v3, v4, v5}, Lkap$b;-><init>(Landroid/graphics/Bitmap;J)V

    :try_start_0
    invoke-static {p1}, Lkap;->a(Ljava/lang/String;)Lkap$a;
    :try_end_0
    ...
    :cond_0
    :try_start_1
    iget v2, v1, Lkap$a;->b:I

    int-to-long v4, v2

    iput-wide v4, v0, Lkap$b;->b:J

    iget-object v1, v1, Lkap$a;->a:[B
    ...
    :try_start_2
    invoke-static {p0, v2}, Lkap;->a(Landroid/content/Context;Ljava/io/InputStream;)I
    ...
    iput-object v1, v0, Lkap$b;->a:Landroid/graphics/Bitmap;
    :try_end_2
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_2} :catch_1
    .catchall {:try_start_2 .. :try_end_2} :catchall_0

    :goto_1
    invoke-static {v2}, Ljur;->a(Ljava/io/InputStream;)V
