...
.method constructor <init>(Ljava/io/InputStream;Ljava/lang/String;)V
    ...
    invoke-direct {v0, p1}, Lktw;-><init>(Ljava/io/InputStream;)V
    ...
    invoke-virtual {v0, v3}, Lktu;->a(Ljava/lang/String;)[B
...
.method private toASN1Object(Ljava/security/cert/X509Certificate;)Lkvm;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method private toDEREncoded(Lktu;)[B
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertificateEncodingException;
    ...
    invoke-virtual {p1, v0}, Lktu;->a(Ljava/lang/String;)[B
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getEncoded(Ljava/lang/String;)[B
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/jce/provider/PKIXCertPath;->toASN1Object(Ljava/security/cert/X509Certificate;)Lkvm;
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/jce/provider/PKIXCertPath;->toDEREncoded(Lktu;)[B
    ...
    sget-object v1, Lkxd;->H:Lkvn;

    invoke-direct {v3, v1, v5}, Lkxb;-><init>(Lkvn;Lkva;)V

    new-instance v6, Lktv;

    invoke-direct {v6}, Lktv;-><init>()V
    ...
    invoke-virtual {v6, v0}, Lktv;->a(Lkva;)V
    ...
    invoke-direct {v4, v6}, Lkvu;-><init>(Lkvb;)V

    new-instance v6, Lkvu;

    invoke-direct {v6}, Lkvu;-><init>()V

    invoke-direct/range {v0 .. v6}, Lkxh;-><init>(Lkvj;Lkue;Lkxb;Lkue;Lkue;Lkue;)V

    new-instance v1, Lkxb;

    sget-object v2, Lkxd;->I:Lkvn;

    invoke-direct {v1, v2, v0}, Lkxb;-><init>(Lkvn;Lkva;)V

    invoke-direct {p0, v1}, Lorg/bouncycastle/jce/provider/PKIXCertPath;->toDEREncoded(Lktu;)[B
    ...
    invoke-direct {v2, v3}, Llba;-><init>(Ljava/io/Writer;)V
    ...
    invoke-virtual {v2, v3}, Llba;->a(Ljava/lang/Object;)V
    ...
    :cond_4
    invoke-virtual {v2}, Llba;->close()V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
