...
.method static convertFramerates([Landroid/util/Range;I)Ljava/util/List;
    ...
    .line 242
    .local v1, "ranges":Ljava/util/List;, "Ljava/util/List<Lorg/webrtc/ali/CameraEnumerationAndroid$CaptureFormat$FramerateRange;>;"
    array-length v4, p0
    ...
    new-instance v5, Lorg/webrtc/ali/CameraEnumerationAndroid$CaptureFormat$FramerateRange;
    ...
    invoke-direct {v5, v6, v2}, Lorg/webrtc/ali/CameraEnumerationAndroid$CaptureFormat$FramerateRange;-><init>(II)V
...
.method private static convertSizes([Landroid/util/Size;)Ljava/util/List;
    ...
    .line 232
    .local v1, "sizes":Ljava/util/List;, "Ljava/util/List<Lorg/webrtc/ali/Size;>;"
    array-length v3, p0
...
.method private getCameraCharacteristics(Ljava/lang/String;)Landroid/hardware/camera2/CameraCharacteristics;
    ...
    .line 95
    :try_start_0
    iget-object v1, p0, Lorg/webrtc/ali/Camera2Enumerator;->cameraManager:Landroid/hardware/camera2/CameraManager;
...
.method static getSupportedFormats(Landroid/hardware/camera2/CameraManager;Ljava/lang/String;)Ljava/util/List;
    ...
    .prologue
    .line 175
    sget-object v22, Lorg/webrtc/ali/Camera2Enumerator;->cachedSupportedFormats:Ljava/util/Map;

    monitor-enter v22

    .line 176
    :try_start_0
    sget-object v21, Lorg/webrtc/ali/Camera2Enumerator;->cachedSupportedFormats:Ljava/util/Map;
    ...
    invoke-static {v10}, Lorg/webrtc/ali/Camera2Enumerator;->getFpsUnitFactor([Landroid/util/Range;)I

    move-result v21

    move/from16 v0, v21

    invoke-static {v10, v0}, Lorg/webrtc/ali/Camera2Enumerator;->convertFramerates([Landroid/util/Range;I)Ljava/util/List;

    move-result-object v12

    .line 198
    .local v12, "framerateRanges":Ljava/util/List;, "Ljava/util/List<Lorg/webrtc/ali/CameraEnumerationAndroid$CaptureFormat$FramerateRange;>;"
    invoke-static {v4}, Lorg/webrtc/ali/Camera2Enumerator;->getSupportedSizes(Landroid/hardware/camera2/CameraCharacteristics;)Ljava/util/List;

    move-result-object v17

    .line 200
    .local v17, "sizes":Ljava/util/List;, "Ljava/util/List<Lorg/webrtc/ali/Size;>;"
    const/4 v5, 0x0
    ...
    check-cast v11, Lorg/webrtc/ali/CameraEnumerationAndroid$CaptureFormat$FramerateRange;

    .line 202
    .local v11, "framerateRange":Lorg/webrtc/ali/CameraEnumerationAndroid$CaptureFormat$FramerateRange;
    iget v0, v11, Lorg/webrtc/ali/CameraEnumerationAndroid$CaptureFormat$FramerateRange;->max:I
    ...
    .end local v11    # "framerateRange":Lorg/webrtc/ali/CameraEnumerationAndroid$CaptureFormat$FramerateRange;
    .end local v12    # "framerateRanges":Ljava/util/List;, "Ljava/util/List<Lorg/webrtc/ali/CameraEnumerationAndroid$CaptureFormat$FramerateRange;>;"
    .end local v17    # "sizes":Ljava/util/List;, "Ljava/util/List<Lorg/webrtc/ali/Size;>;"
    ...
    .restart local v12    # "framerateRanges":Ljava/util/List;, "Ljava/util/List<Lorg/webrtc/ali/CameraEnumerationAndroid$CaptureFormat$FramerateRange;>;"
    .restart local v17    # "sizes":Ljava/util/List;, "Ljava/util/List<Lorg/webrtc/ali/Size;>;"
    ...
    .line 206
    .local v9, "formatList":Ljava/util/List;, "Ljava/util/List<Lorg/webrtc/ali/CameraEnumerationAndroid$CaptureFormat;>;"
    ...
    check-cast v16, Lorg/webrtc/ali/Size;
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0

    .line 207
    .local v16, "size":Lorg/webrtc/ali/Size;
    ...
    iget v0, v0, Lorg/webrtc/ali/Size;->width:I

    move/from16 v25, v0

    move-object/from16 v0, v16

    iget v0, v0, Lorg/webrtc/ali/Size;->height:I
    ...
    :goto_4
    :try_start_5
    new-instance v23, Lorg/webrtc/ali/CameraEnumerationAndroid$CaptureFormat;
    ...
    invoke-direct {v0, v1, v2, v3, v13}, Lorg/webrtc/ali/CameraEnumerationAndroid$CaptureFormat;-><init>(IIII)V
    ...
    invoke-static/range {v23 .. v24}, Lorg/webrtc/ali/Logging;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .end local v16    # "size":Lorg/webrtc/ali/Size;
    :cond_3
    sget-object v21, Lorg/webrtc/ali/Camera2Enumerator;->cachedSupportedFormats:Ljava/util/Map;
    ...
    .restart local v16    # "size":Lorg/webrtc/ali/Size;
    :catch_1
    move-exception v23
...
.method static getSupportedSizes(Landroid/hardware/camera2/CameraCharacteristics;)Ljava/util/List;
    ...
    .line 157
    .local v1, "filteredSizes":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lorg/webrtc/ali/Size;>;"
    ...
    check-cast v3, Lorg/webrtc/ali/Size;

    .line 158
    .local v3, "size":Lorg/webrtc/ali/Size;
    invoke-virtual {v0}, Landroid/graphics/Rect;->width()I

    move-result v8

    iget v9, v3, Lorg/webrtc/ali/Size;->height:I
    ...
    iget v10, v3, Lorg/webrtc/ali/Size;->width:I
    ...
    .end local v1    # "filteredSizes":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lorg/webrtc/ali/Size;>;"
    .end local v3    # "size":Lorg/webrtc/ali/Size;
    :cond_1
    move-object v1, v4
...
.method public static isSupported(Landroid/content/Context;)Z
    ...
    invoke-static {v5, v7}, Lorg/webrtc/ali/Logging;->e(Ljava/lang/String;Ljava/lang/String;)V
